...
export const en: Record<keyof typeof sq, string> = {
  ...
  'rail.label': 'Quick filters',
  'rail.nearMe': 'Near me',
  'rail.locating': 'Finding you…',
  'rail.locateError': "Couldn't find your location. Allow location access and try again.",
  'rail.dismiss': 'Dismiss',
  'mood.preset.quick': 'Quick bite',
  'mood.preset.hearty': 'Something hearty',
  'mood.preset.date': 'Date night',
  'mood.preset.light': 'Light & fresh',
  'filters.show': 'Show {n} places',
  'filters.showOne': 'Show 1 place',
  'filters.showNone': 'No places',
  'card.closesAt': 'Closes {time}',
  'card.opensAt': 'Opens {time}',
  'detail.backShort': 'Back',
  'detail.share': 'Share',
  'detail.linkCopied': 'Link copied',
  'detail.today': 'Today',
  'detail.similar': 'Similar places nearby',
  'saved.title': 'Saved',
  'saved.empty': 'Tap the heart on any place you like and it lands here.',
  'saved.signedOutTitle': 'Keep the places you love',
  'saved.signedOutBody': 'Sign in to save places with one tap and find them here on any device.',
  'account.guestTitle': 'Welcome',
  'account.guestBody': 'Sign in to save your favourite places and share photos from your visits.',
